<template>
  <div id="carouselExampleDark" class="carousel carousel-dark slide">
    ...
    <button style="background-color: #504d4d; opacity: 1; border: 0.3px solid #94837d;" class="carousel-control-prev d-lg-block d-none" type="button" data-bs-target="#carouselExampleDark"
      data-bs-slide="prev">
      <span class="py-[4px] px-[8px]">
        <i style="color: #fff;" class="bi bi-chevron-left"></i>
      </span>
      <span class="visually-hidden">Previous</span>
    </button>
    <button style="background-color: #504d4d; opacity: 1; border: 0.3px solid #94837d;" class="carousel-control-next d-lg-block d-none" type="button" id="nextbtn"
      data-bs-target="#carouselExampleDark" data-bs-slide="next">
      <span class="py-[4px] px-[8px]">
        <i style="color: #fff;" class="bi bi-chevron-right"></i>
      </span>
...
export default {
  ...
  methods: {
    async trendComp() {
      try {
        let response_trend = await homeGet(`/home-trending-country/Study Visa`)
