  ...
  <div class="gallery-container">
    <div class="lead-setting">
      <span class="fs-4 fw-semibold text-[#808080]">Basic Details</span>
       ...
       <span v-if="errors.other_fields" class="text-red-500">{{ errors.other_fields }}</span>
    <div class="lead-detail mt-2 row">
        ...
        <div class="row otherfld-laled">
          <div id="other-fldids" class="form-group col-4 d-lg-flex flex-lg-column pt-4 pt-lg-0"
            ...
            <div v-if="i.field_type == 'input'">
              <label for="exampleInputPassword1" class="required">{{ i.field_name }} <span v-if="i.required">*</span></label>
            ...
            <div v-if="i.field_type == 'dropdown'"  class="required">
