<template class="template">
    ...
    <div class="row common">
      <div class="col-lg-12 pt-5 mb-sm-0">
        ...
        <div class="flex flex-col items-center gap-2">
          <p style="font-size: 30px;">Visa Categories & Countries</p>
          <p style="text-align: center; font-size: 15px;width: 42%;">Simply select the visa types and corresponding
            countries you cater to, so we can tailor the platform to match your expertise.</p>
        </div>
        <!-- <center> -->
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available ">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.residency ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.residency? '/img/svg/Homepage/White/House.svg':'/img/svg/residency.svg'" alt="" class="h-[30px] w-[30px]" />
                  </div>
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.study ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.study ? '/img/svg/Homepage/White/School.svg': '/img/svg/study.svg' " alt="" class="h-[30px] w-[30px]" />
                  </div>
                  <div class="px-4 d-flex flex-column" style="font-weight: 500">
                    Study Visa
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.business ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.business ? '/img/svg/Homepage/White/Monetization on.svg':'/img/svg/business.svg'" alt="" class="h-[30px] w-[30px]" />
                  </div>

                  <div class="px-4 d-flex flex-column" style="font-weight: 500">
                    Business Visa{{ checkboxStates.business }}
                    <span v-if="checkboxStates.business" style="color: #818caf">

                      <!-- If no countries are selected -->
                       <!-- {{ this.$refs.businessModal.selectedcountries}} -->
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.tourist ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.tourist ?'/img/svg/Homepage/White/Explore.svg':'/img/svg/tourist.svg'" alt="" class="h-[30px] w-[30px]" />
                  </div>
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.visitor ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.visitor ?'/img/svg/Homepage/White/Assignment ind.svg':'/img/svg/visitor.svg'" alt="" class="h-[30px] w-[30px]" />
                  </div>
                  <div class="px-4 d-flex flex-column" style="font-weight: 500">
                    Visitor Visa
              ...
              <div class="d-flex justify-content-between align-items-center" style=" height: -webkit-fill-available">
                <div class="d-flex align-items-center">
                  <div class="image-holder" :style="{ background: checkboxStates.work ? '#ff6262' : '#fff0f1' }">
                    <NuxtImg :src="checkboxStates.work ?'/img/svg/Homepage/White/Work.svg':'/img/svg/work.svg'" alt="" class="h-[30px] w-[30px]" />
                  </div>
  ...
  <AllModals :countries="countries" ref="allModal"  />
  <AllModals :countries="countries" ref="prModal"  data="Pemanent Residency"/>
  <AllModals :countries="countries" ref="studyModal" data="Study Visa"/>
  <AllModals :countries="countries" ref="touristModal" data="Tourist Visa" />
  <AllModals :countries="countries" ref="businessModal" data="Business Visa"/>
  <AllModals :countries="countries" ref="visitorModal" data="Visitor Visa"/>
  <AllModals :countries="countries" ref="workModal" data="Work Visa"/>
