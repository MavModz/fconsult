  ...
  <div class="offers-container  customclass-listing-container">
    ...
    >
      ...
      <div class="d-flex align-items-center gap-3">
        <span @click="goToSearch('business-listing', 'Visitor Visa')"  class="ms-4 cursor-pointer"
...
export default {
  ...
  methods: {
    ...
    async fetchData(country = '') {
      try {
        const url = country
          ? `/home-review-companies-all/Visitor Visa/${country}`
          : `/home-review-companies-all/Visitor Visa`;
    ...
    async countriesServices() {
      try {
        const response = await homeGet(
          `/home-review-Listing-country/Visitor Visa`,
        );
        if (response.status) {
