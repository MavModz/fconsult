      ...
      <div class="row compa-style-grid">
        ...
        <div class="col-md-8 col-12 cstm-widdth-cmpp">
          <div class="title d-flex justify-content-between align-items-center mb-[30px] near-by-clss">
            ...
            <span @click="goToSearch('business-listing', 'Visitor Visa')" class="ms-4">View all <i class="bi bi-arrow-right w-4"></i>
            </span>
          </div>
          <div>
...
export default {
  ...
  methods: {
    ...
    async init() {
      await homeGet(`/home-companies/Visitor Visa`).then((response) => {
        if (response.status) {
