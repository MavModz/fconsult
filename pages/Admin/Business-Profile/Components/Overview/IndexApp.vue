...
<template>
  ...
  <div class="flex gap-[20px] whole  lg:gap-[30px]">
    <div class=" first-container  lg:w-[56%] xl:w-[60%]">
      <div class="cards left-side-card">
        <div class="card-body">
          <div class="card-title gap-[9px] flex-wrap">
        ...
        <div class="card-body">
          ...
          <div class="all-countries md:gap-[20px] gap-[14px]">
            <div class="countries py-[5px] md:px-[12px] px-[8px] col-sm-2 shadow-sm divhover whitespace-nowrap " v-for="country in selectedCountry"
    ...
    <div class=" second-container lg:w-[42%] xl:w-[38%] px-3">
      <div class="cards">
        <div class="card-body">
          <div class="card-title">
            <h5>Contact Info</h5>
