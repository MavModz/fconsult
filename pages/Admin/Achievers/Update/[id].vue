    ...
    <div class="update-wrapper">
      <FormKit type="form" :value="achiverlist" >
        <div class="update-events-content row">
          ...
          <div v-if="icon_url" class="update-events-right col-lg-4 relative">
  <div class="update-event-right-wrap w-[275px] relative">
    <!-- Display the image -->
    <div
      class="labelclass1 bg-cover "
      :style="'background-image:url(' + icon_url + ')'"
    >
      <!-- Edit Icon (top right corner) -->
      <span
        class="absolute top-3 right-2 bg-white px-2 py-1 rounded-full shadow cursor-pointer z-10"
    ...
    <!-- Hidden FormKit binding to icon_url -->
    <FormKit
      validation="required"
      name="cover_image"
      type="text"
