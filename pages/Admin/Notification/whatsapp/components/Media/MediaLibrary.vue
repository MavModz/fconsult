        ...
        <div class="media-lib-header">
            <div class="media-lib-search">
                ...
                <div class="media-lib-btns flex gap-2">
                    ...
                    <button class="media-lib-btn upload flex items-center gap-1" @click="triggerFileInput">
        ...
        <div class="media-lib-wrapper">
            ...
            <div class="gallery-item" v-for="items in filteredGalleryData" :key="items._id" style="position:relative;">
                <template v-if="items.media_type === 'image'">
                    <NuxtImg :src="items.media_url" :alt="items.media_title"
                        style="width:100px;height:100px;object-fit:cover;border-radius:8px;" />
                </template>
                <template v-else-if="items.media_type === 'video'">
                    <video :src="items.media_url" autoplay muted loop
    ...
    methods: {
        ...
        async uploadFile() {
            ...
            try {
                ...
                const response = await adminPost('/add-wa-media', {
        ...
        async fetchMedia() {
            try {
                const response = await adminGet('/wa-media');
                if (response.status === true && response.data.data !== undefined) {
