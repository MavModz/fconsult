...
<template>
  <div class="md:px-4 sm:px-3 px-2 md:py-[50px] py-[30px] flex flex-col justify-between h-screen">
    <div>
      <h2 class="md:text-[31px] text-[26px] sm:text-[29px] md:leading-[45px] sm:leading-[39px] leading-[35px] text-[#1f1f1f] font-medium mt-2 mb-3 md:mb-4">
