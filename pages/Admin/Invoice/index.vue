        ...
        <div class="languages pb-[25px]">
            <div class="gallery-media-action">
                <div class="gallery-action">
                    ...
                    <div>
                        <input type="text" class="searchicon" placeholder="Search..." v-model="searchQuery"
                            @input="searchbylisting" />
                    </div>
                ...
                <div class="admin-invoice-generate-invoice" @click="sendaddpayment('abc')">
                    <button ><i class="bi bi-plus-circle-fill"></i> Generate Invoice</button>
                </div>
            </div>
            <section>
                <table>
                    ...
                    <tbody>
                        <tr v-for="i in invoice_list">
                            ...
                            <td>
  <span>{{ formatIndian(i.total_amount) }}</span>
  <span class="payment-full ml-2" v-if="i.emi.length == 0">Full</span>
  <span class="payment-emi ml-2" v-if="i.emi.length > 0">
    {{ getPaidEmiCount(i.emi) }} / {{ i.emi.length }}
  </span>
</td>
                            <td>
