  ...
  <div class="pipline-view-container">
    <div class="pipline-view-wrapper">
      ...
      <div class="pipline-view-body-container">
        ...
        <div class="scroll-abs-ledsaptt">
          <i @click="scrollLeft" id="scroller-leadss" class="fa fa-angle-down"></i>
        </div>
        <div class="scroll-abs-ledsaptt-left">
          ...
          <div class="single-lead-inside-name-view">
            ...
            <span>
              <div id="single-leads-sdwedk" class="mb-3">
                <FormKit validation="required" id="update-events-drpsemi-leads" name="city" type="select"
                      ...
                      <div class="form-url-frm">
                        <span class="frm-url-wid">
                          ...
                          <div class="mb-3">
                            ...
                            <FormKit validation="required" v-model="selectedTab" id="form-url-inpt" class="form-select"
                              name="event_type" type="select" :options="['1', '2']" />
                          </div>
                        </span>
                        <span class="frm-url-wid">
                          <div class="mb-3">
