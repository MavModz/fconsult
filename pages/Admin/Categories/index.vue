<template>
  <div class="bg-white px-[20px] py-[20px] flex justify-between gap-2 flex-wrap rounded-[4px] cursor-pointer m-[7px]">
  ...
  <div
    class="mt-[20px] flex flex-wrap gap-[20px] p-[7px]">
    <div v-for="(item, index) in countriesVisaCategories" :key="index + item._id"
      class="bg-white md:px-[28px] w-[355px] xl:min-w-[390px] 2xl:min-w-[430px] px-[20px] py-[20px] flex flex-col gap-4 rounded-lg">
  ...
  <div class="offcanvas offcanvas-end offcanv-strst-filter max-w-[560px!important] w-[100%!important]" tabindex="-1"
    ...
    <div class="modal-body-offcan-trst">
      ...
      <div class="relative mt-[40px]">
        ...
        <div class="flex flex-col gap-3 px-[30px] h-[520px] overflow-auto">
