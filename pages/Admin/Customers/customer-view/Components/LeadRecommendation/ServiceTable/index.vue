...
export default {
    ...
    methods: {
        ...
        async listingdata(service, subservice) {
            ...
            const listing = await adminGet(url);
        ...
        async countrylist() {
            try {
                const data = await adminGet(`/countries-by-service-subservice/?service=${this.selectedService}&subservice=${this.selectedSubService}`)
        ...
        async filedList() {
            try {
                const data = await adminGet(`/program-categories/${this.selectedService}/${this.selectedSubService}`)
