<template>
    <div v-for="section in integrationSections" :key="section.title" class="mb-3">
  <div class="crm-details mb-3">
    <div>
      <h3 clas="font-semibold">{{ section.title }}</h3>
      <p class="mb-0">{{ section.description }}</p>
    </div>
  </div>

  <div class="row">
    <div class="col-sm-4" v-for="data in section.items" :key="data.id">
        ...
        <div class="card-body" :class="{
          ...
          <div class="upper-section">
            <div class="upper-icon mb-3">
              <img :src="'/img/svg/' + data.image" height="50px" width="50px" alt="Icon" />
            </div>
          </div>
    ...
    <div class="col-md-12">
      <div class="crm-details">
        <div>
          ...
          <p class="mb-0">Discover tools to automate workflows and seamlessly sync data with multiple sources, enhancing efficiency
            and
      ...
      <div class="crm-details mt-5">
        <div>
          <h3>Communication Integrations</h3>
          <p>Connect communication platforms to streamline conversations and keep your team updated in real time.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4" v-for="data in communicationModules" :key="data.id">
          <IntegrationCard :data="data" @get-started="getStarted" @redirect-to-plans="redirectToPlans" />
        </div>
      </div>

        <div class="crm-details mt-5">
        <div>
          <h3>Video Conferencing Integrations</h3>
          <p>Integrate video conferencing tools to schedule, join, and manage virtual meetings directly from your CRM.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4" v-for="data in videoConferencingModules" :key="data.id">
          <IntegrationCard :data="data" @get-started="getStarted" @redirect-to-plans="redirectToPlans" />
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
       integrationSections: [
      {
        ...
        description: "Discover tools to automate workflows and seamlessly sync data with multiple sources, enhancing efficiency and simplifying processes.",
        items: [
           {
          id: 1,
          name: 'Meta AD’s',
      ...
      },
      {
        ...
        description: "Connect with your audience using powerful video conferencing tools directly integrated into your CRM.",
        items: [
          {
             id: 7,
          name: 'Razorpay Integration',
          image: 'razorpay-logo.svg',
          description: `Create Your Own Forms and Integrate Seamlessly with Any Custom Website 
          or Landing pages to Fetch Leads Directly into Your CRM.`,
          isUpcoming: false,
          crmIncuded: true,
      ...
      {
        title: "Communication",
        description: "Integrate messaging tools to keep your team and users aligned across multiple platforms.",
        items: [
           {
          id: 8,
        ...
        items: [
          {
            id: 10,
            name: 'Google Meet',
            image: 'GoogleMeet.svg',
            description: `Generate Google Meet links for calendar invites automatically.`,
            isUpcoming: true,
            crmIncuded: true,
            route: "/admin/"
          }
 ...
 mounted() {
    activateMenu('integrations', 'Lead Integration');
