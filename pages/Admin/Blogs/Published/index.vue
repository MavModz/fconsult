                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a class="dropdown-item" @click="draftBlog(i._id)">
                          <BootstrapIcon name="star" class="icon5" />Set Draft
                        </a>
                      </li>
                    </ul>
                  </div> -->
                  <!-- <BootstrapIcon class="sunew" v-if="i.su.status == 'new'" v-tooltip.top="i.su.comment"
                    name="exclamation-circle" />
                  <BootstrapIcon class="sureject" v-if="i.su.status == 'rejected'" v-tooltip.top="i.su.comment"
                    name="x-circle" />
                  <BootstrapIcon class="suapprove" v-if="i.su.status == 'approved'" v-tooltip.top="i.su.comment"
                    name="check-all" /> -->
