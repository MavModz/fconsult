                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <InputSwitch v-model="subadminData.recommendation.view" class="mt-2" />
                                </td>
                                <td>
                                    <InputSwitch v-model="subadminData.recommendation.add" class="mt-2" />
                                </td>
                                <td>
                                    <InputSwitch v-model="subadminData.recommendation.edit" class="mt-2" />
                                </td>
                                <td>
                                    <InputSwitch v-model="subadminData.recommendation.delete" class="mt-2" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
