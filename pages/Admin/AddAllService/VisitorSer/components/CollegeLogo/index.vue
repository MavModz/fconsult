...
<template>
  <div class="mb-4 relative">
    ...
    ></div>
    <span class="text-[#666276] absolute top-[66px] left-[90px]"
      >Logo</span
    >
    <img
      class="absolute right-[28px] top-[55px] w-[16px] -translate-x-[-50%] -translate-y-[-50%]"
      src="/img/svg/file-upload.svg"
      alt=""
    />
    <input
      type="file"
      @change="handleImageChange($event, 'listService.collegeLogo')"
      class="absolute right-0 bottom-0 w-[70px] h-[75px] opacity-0"
    />
    <img
      class="absolute top-[50px] left-[15px] rounded-md w-[60px]"
      :src="
