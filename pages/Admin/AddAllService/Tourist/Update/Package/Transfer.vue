	...
	<div class="pricing-transport-conta">
		<div class="pricing-transport-heading">
			<div class="pricing-transport-heading-car">
				...
				<span class="pricing-trans-detais">Transfer Details</span>
			</div>
			<div class="">
		...
		<div>
			<div class="pricing-trans-cmpny-flx">
				<div class="mb-3 jobliscmp-dro">
					...
					<FormKit v-model="x.transfer_field.type" type="select" :options="['it', 'technology']"
				...
				<div class="tourist-bsc-dic-wd">
					...
					<FormKit v-model="x.transfer_field.company" type="text" placeholder="Indigo"
						class="tourist-transport-inpt1st" />
				</div>

				<div class="mb-3 jobliscmp-dro">
					<label class="tourist-transport-lable">Transportation Class</label>
					<FormKit v-model="x.transfer_field.class" id="updateevents-drpsemi" class="form-select"
						type="select" :options="['it', 'technology']" />
				</div>
			</div>
			...
			<div class="tourist-transport-2stbx">
				<div class="tourist-bsc-dic-wd2">
					...
					<FormKit v-model="x.transfer_field.departure" type="datetime-local"
						class="tourist-transport-inpt1st" />
				</div>
				<div class="tourist-bsc-dic-wd2">
					<span class="tourist-bsc-dic-checkbx">
						<label class="tourist-basc-lble">Layover / Stopage</label>
						<FormKit v-model="x.transfer_field.stopage" type="checkbox" />
					</span>
					<FormKit v-model="x.transfer_field.arrival" type="datetime-local"
						class="tourist-transport-inpt1st" />
				</div>
			</div>
			...
			<div class="tourist-transport-2stbx">
				<div class="tourist-bsc-dic-wd2">
					Departure Location
					<FormKit v-model="x.transfer_field.departure_location" type="text"
				...
				<div class="tourist-bsc-dic-wd2">
					...
					<FormKit v-model="x.transfer_field.destination_location" type="text"
						placeholder="Lorem ipsum dolor sit amet consectetur. Urna."
						class="tourist-transport-inpt1st-depart" />
				</div>
			</div>
			...
			<div class="tourist-transport-despstbx">
				...
				<FormKit v-model="x.transfer_field.description" type="textarea" class="tourist-transport-inpt1st" />
			</div>

			<div class="tourist-trans-delt-paddng">
				<div class="tourist-trans-delt-additm">
					<span>Add Tags</span>
					<Chips v-model="x.transfer_field.tags" />
				</div>
			</div>
		</div>
...
export default {
	...
	mounted(){
if (this.x.transfer_field.price) {
      this.allUsers = [...this.x.transfer_field.price];
      this.alltempUser = [...this.x.transfer_field.price];
    }
	},
	methods: {
		submitForm(v) {
		...
		closefinal() {
			...
			this.x.transfer_field.price= [...this.alltempUser];
