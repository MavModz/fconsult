      ...
      <div class="tourist-basic-wrapper">
        <div class="tourist-basic-1st">
          ...
          <div class="input-field">
            ...
            <FormKit validation="required" name="destination_address" type="text" placeholder="address" />
          </div>

          <div class="input-field">
            <label for="field-name">Description</label>
            <FormKit validation="required" name="description" as="textarea" placeholder="add your description here" />
          </div>
...
export default {
  ...
  async mounted() {
    ...
    this.$refs.allimages.all_images = this.data.media_list
    ...
    console.log(this.data.media_list)
    console.log("dtatatdtadata",this.data)
  },
  methods: {
    async submitForm(v) {
      ...
      // } else {
        ...
        adminPut(`/admin-study-update/${this.$route.params.id}`, v).then((response) => {
          this.loading = false
          this.tabs=[]
          this.$router.push({
