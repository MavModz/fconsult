<template>
    <div class="row mx-0">
      <div class="col-md-12">
        <div class="crm-details">
          ...
          <p>Discover tools to automate workflows and seamlessly sync data with multiple sources, enhancing efficiency and simplifying processes.</p>
        </div>
        <br />
        <div class="row">
  ...
  export default {
    ...
    // },
    {
      ...
      isUpcoming: false,
      crmIncuded: true,
      route:"/admin/settings/LeadManagement/WebHooks/indexApp"
    },
    {
      id: 6,
      name: 'Meta AD’s',
      ...
      isUpcoming: false,
      crmIncuded: true,
      route:"/admin/settings/LeadManagement/WebHooks/FaceBook"
    },
    // {
    //   id: 3,
    ...
    // },
    {
      ...
      isUpcoming: false,
      crmIncuded: true,
      route: '/admin/leads/view/LeadAutomation',
...
.upcoming-strip .lock-icon i {
  font-size: 16px;
  color: #F76060; /* Blue color for lock icon */
}
