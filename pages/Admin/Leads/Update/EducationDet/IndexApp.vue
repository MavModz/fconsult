...
<template>
  ...
  <Dialog v-model:visible="addPrimaryModal" modal header="Add Primary Education Details">
  ...
  <Dialog v-model:visible="addProfessionalModal" modal header="Add Professional Course Details">
