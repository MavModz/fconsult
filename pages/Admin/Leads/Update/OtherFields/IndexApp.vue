...
export default {
  ...
  mounted() {
  if (this.lead.other_fields == null || this.lead.other_fields === undefined) {
    this.lead.other_fields = [];
  }
    this.init();
  },
  methods: {
    async init() {
      ...
      console.log("console.log(this.lead.other_fields", this.lead.other_fields)
