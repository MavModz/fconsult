  ...
  <div class="form-section">
    ...
    <div class="grid">
      <div class="input-group">
        ...
        <input type="text" placeholder="-------------------" required @input="clearError('collegeName')"  v-model="listService.collegeName" />
      ...
      <div class="input-group">
        ...
        <input type="text" v-model="listService.state" @input="clearError('state')" placeholder="-------------------" required />
    ...
    <div class="input-group mb-4">
      ...
      <input v-model="listService.pincode" type="text" @input="clearError('pincode')" placeholder="-------------------" required inputmode="numeric" />
    ...
    <div class="input-gp">
      ...
      <div class="study-visa-description-block">
        <QuillEditor :modules="modules" ref="qhtml"  class="mb-4" style="height:200px" @input="validateQuillEditor"/>
      ...
      <div class=grid>
        ...
        <div class="input-grp">
          ...
          <div class="flex border-[1px] border-[#D5D2DC] rounded-[10px]  py-[6px]">
            ...
            <input type="text" class=" border-0   outline-none" placeholder="------------------" required
              v-model="listService.living_expenses" @keypress="restrictToNumbers">
          </div>
        ...
        <div class="grid mt-3">
          ...
          <div class="input-grou">
            ...
            <div class="flex border-[1px] border-[#D5D2DC] rounded-[10px]  py-[6px]">
              ...
              <span class="border-r-[1px] ml-2 rounded-0 border-l-[0px] border-y-[0px]"></span>
              <input type="text" class=" border-0   outline-none" placeholder="------------"
                v-model="program.application_fee" inputmode="numeric" pattern="\d{6,}"
                @input="onlyDigits($event, 'fee')">
            </div>
          </div>
          <div class="input-group">
          ...
          <div class="input-grou">
            ...
            <div class="flex border-[1px] border-[#D5D2DC] rounded-[10px]  py-[6px]">
              ...
              <span class="border-r-[1px] ml-2 rounded-0 border-l-[0px] border-y-[0px]"></span>
              <input type="text" class=" border-0   outline-none" placeholder="------------"
                v-model="program.annual_tution_fee" required inputmode="numeric" pattern="\d{6,}"
                @input="onlyDigits($event, 'tution_fee')">
            </div>
          </div>
        </div>
        <div class="input-group">
...
export default {
 ...
 successAlert('Media Disabled successfully.')
    ...
    validateDates() {
      ...
      if (start < now) {
    errorAlert("Start date cannot be in the past");
    this.program.course_start_date = null;
  }
    },
