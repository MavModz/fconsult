                ...
                <div class="lead-header-left">
                    <div class="d-flex image-gap align-items-center mr-1">
                        ...
                        <div class="lead-info">
                            ...
                            <div class="lead-meta">Created On <span class="lead-meta-date">{{ convertDate(lead.date)}}</span></div>
                        ...
                        <div class="full-width">
                            ...
                            <div v-if="isShowing" class="tooltip-box">
                                This lead has Inquired <strong>{{ lead.inquiry_count }} </strong> Time(s) by <strong> {{
                                    lead.source }}</strong> source on <span class="highlight">{{ convertDate(lead?.date)}}</span>
                ...
                <div v-if="isOpen">
                    ...
                    <div class="info-row mt-[18px]">
                        <div class="info-block">
                         ...
                         <p :title="lead?.email">{{ truncatedEmail }}</p>
...
/>
    ...
    <Dialog v-model:visible="openMailComposer" modal header="Email Composer" position="bottom"
        class=" custom-bottom-right-dialogs w-[100vw] sm:w-[80vw] md:w-[69vw] lg:w-[58vw] xl:w-[49vw] 2xl:w-[38vw]">
        <div class="  right-sec  ">
            <div class=" border-b-[2px] border-b-[#ededed]   bg-white h-fit">
                <!-- <div
                ...
                <div class="  h-[400px] md:h-[490px]">
                    ...
                    <div
                        ...
                        <div id="custom-toolbar" class="border-none py-2 bg-white">
            ...
            <div class="flex justify-end">
                <div @click="sendLeadEmail"
                    class="mt-3 flex w-[130px] gap-2 justify-center cursor-pointer items-center  bg-[#FF57571A] text-[#FF5757] text-[17px] font-semibold py-[8px] sm:py-[9px] rounded-[8px]">
...
export default {
    ...
    computed: {
      ...
      // Truncate only if width < 600px
      if (this.windowWidth < 600 && this.lead.email.length > 28) {
        return this.lead.email.slice(0, 28) + "...";
      }
