        ...
        <div class="gallery-media-action">
          <div class="gallery-action">
            <div class="d-flex gap-3 gallery-header">
              ...
              <div class="todo-row1">
  <!-- <button @click="selectCategory('All')" class="todo-row1-button dark-active">
    All
  </button> -->
  <div class="dropdown">
    <button class="todo-row1-button" data-bs-toggle="dropdown" aria-expanded="false" @click="selectCategory('Choose Category')">
        ...
        <a class="dropdown-item" href="#" @click.prevent="selectCategory('Process Document')">
          Process Document
            ...
            <div class="addDocumnetButton d-flex gap-2 align-items-center"
              @click="$refs.docSidebar.addDocSidebar = true">
