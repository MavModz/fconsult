    ...
    <div class="a-container mt-[32px]">
        <div class="top-bar">
            <div class="d-flex align-items-center  flex-wrap gap-4 justify-content-center md:justify-start">
                ...
                <div class="tabs flex-wrap flex items-center gap-[18px]">
...
<div v-if="filteredAppointments.length === 0" class="no-appointment text-muted">
 ...
 <div class="cards mt-3">
                <div class="appointment-card" v-for="(ele, ind) in filteredAppointments">
                    <div class="appointment-header xs:flex-row flex-col d-flex align-items-center   sm:gap-[16px] ">
                        ...
                        <div class="details mt-3 sm:mt-0">
                            <h3>Appointment</h3>
  ...
  @click="ele.status === 'rescheduled-requested' && acceptInvitation(ele)"
>
