    ...
    <div class="flex items-start gap-[20px] md:gap-[27px] md:flex-nowrap flex-wrap mt-[28px]">
        <div class="md:w-[55%] xl:w-[62%] 2xl:w-[65%] w-[100%]">
            ...
            <div class="flex gap-[25px] income-sec items-start mt-[28px]">
                ...
                <div
                    class=" h-[384px] bg-white rounded-[15px] px-[17px] pt-[18px] pb-[23px] w-[42%] border-[2px] border-[#ededed] invoice flex flex-col justify-between">
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-[22px]">
...
export default {
    ...
    mounted() {
     activateSubmenu('c1', ' Customers Dashboard');
        this.TotalData()
    ...
    methods: {
        async TotalData() {
            const data = await adminGet('/customer-dashboard-top-section-data')
            if (data.data.status) {
