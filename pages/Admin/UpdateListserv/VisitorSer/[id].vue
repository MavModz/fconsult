        ...
        <div class="formkit-outer">
          <div class="formkit-wrapper">
            <select class="formkit-input" v-model="listService.country" name="country" required
              aria-required="true" @click="fetchAdminCountries('Visitor Visa')">
      ...
      try {
        if (this.singleListindId) {
          ...
          this.listService = {
            ...
            coverImage: data.visitor?.cover_image || '',
            collegeLogo: data.visitor?.logo || '',
            uploadVideo: data.visitor?.video_url || '',
            videoTitle: data.visitor?.video_title || '',
            ...
            coordinates: data.visitor?.location?.coordinates || [],
            tab: data.visitor?.tabs?.map(tab => ({
              name: tab.tabname || '',
          ...
          //   description: tab.overview || '',
          // }))
          this.AllImagePic = data.visitor?.images || [];
