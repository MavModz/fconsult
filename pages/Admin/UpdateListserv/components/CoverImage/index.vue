...
<template>
  <div
    class="bg-[#F9F8FA] flex justify-center items-center rounded-xl relative"
  >
    ...
    <div class="border-gray p-[20px]" v-else>
      <img src="/img/svg/camera.svg" alt="" /><span
        class="text-[#909090] font-bold text-[22px]"
    ...
    <input
      class="opacity-0 absolute h-[-webkit-fill-available] w-[-webkit-fill-available]"
      type="file"
