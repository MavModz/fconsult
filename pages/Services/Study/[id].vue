            ...
            <div class="container">
                <div class="de_section_w listing-top">
                    ...
                    <div class="row py-14 align-items-center justify-content-between">
                        <center>
                            <h2 class="tittle_25">Study Visa Listing</h2>
                        </center>
                    </div>
                            ...
                            <div class="col-md-12">
                                <section class="listing_section pt-50">
                                    ...
                                    <div class="row">
                                        ...
                                        <NuxtLink :to="'/study/'+i._id" class="col-md-6" v-for="i in listings">
                                            <div class="listings_box_o">
                                                <div class="listings_box_img">
                                                    <img :src="i.study?.logo" alt="">
                                                </div>
...
export default {
    ...
    async mounted() {
        this.listings = (await homeGet(`/home-service-listing/${this.$route.params.id}/Study Visa`)).data.data;
    },
    methods: {
        async submitForm(v) {
