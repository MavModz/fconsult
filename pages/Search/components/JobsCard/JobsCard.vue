    ...
    <div class="country-cards-data">
        <div class="country-card-container">
            <div class="image-area relative">
                <NuxtImg :src="imageUrl" class="card-img" width="438" height="200" />
            ...
            <!-- <div class="price-info-area flex items-center justify-between">
                <div class="company-details-area flex gap-2">
                    <NuxtImg
                        :src=companyImg
                        width="20" height="20" class="company-profile-img" />
                    <span>{{ companyName }}</span>
                </div>
                <div class="price-info-wrapper">
                    <span>Rs {{ priceValue }}</span>
                </div>
            </div> -->
        </div>
    </div>
