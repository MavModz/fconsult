                        ...
                        <div v-for="(item, index) in visibleAchievers" :key="item._id"
                            ...
                            <div>
                                <div class="image-area nuxt-link-hover relative">
                                    <img :src="item?.cover_image" class="card-img" />
                                    <!-- <div class="wishlist-absol">
                                        <img src="/img/png/wishlist.png" alt="">
                                    </div> -->
                                    <div class="image-hovershow w-[25px] h-[25px]" @click="toggleSidebar(item)">
...
export default {
    ...
    methods: {
        ...
        toggleSidebar(data) {
            ...
            console.log("visiblename", name,data)

            if (name === "travel" && data.sub_service_name == "visitor_visa") {
