                    ...
                    <div class="container">
                        <div class="row">
                            <div class="w-[55%] max-[1024px]:w-full">
                                <div class="video-top-btn-grp">
                                    <ul class="nav nav-tabs btng1 justify-content-between">
                                        <li v-if="storeCompanyName" >
                                            <NuxtLink :to="`/immigration-company/${this.storeCompanyName}/f&c-${this.storePermMount}/gallery/media`" class="active">
                                                <span><i class="bi bi-image-fill" aria-hidden="true"></i></span>Media
                                            </NuxtLink>
                                        </li>
                                        <li v-if="storeCompanyName" >
                                            <NuxtLink :to="`/immigration-company/${this.storeCompanyName}/f&c-${this.storePermMount}/gallery/achievers`">
                                                <span><i class="bi bi-info-circle"
                                                        aria-hidden="true"></i></span>Achievers
                                            </NuxtLink>
                                        </li>
                                        <li v-if="storeCompanyName" >
                                            <NuxtLink :to="`/immigration-company/${this.storeCompanyName}/f&c-${this.storePermMount}/gallery/videos`">
                                                <span><i class="bi bi-camera-video"></i></span>Video’s
                                            </NuxtLink>
                                        </li>
                                        <li v-if="storeCompanyName" >
                                            <NuxtLink :to="`/immigration-company/${this.storeCompanyName}/f&c-${this.storePermMount}/gallery/awards`">
                                ...
                                <div class="tab-content">
                                    <div id="pictures" class="tab-pane fade in active show">
                                        <CompanyImages />
                                    </div>
                                </div>
                            </div>
