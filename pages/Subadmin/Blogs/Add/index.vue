...
export default defineComponent({
  ...
  async mounted() {
    ...
    this.category = (await subadminGet(`/company-allblogcategories`)).data.data.map(i => ({ label: i.category_name, value: i.category_name }));
  ...
  methods: {
    ...
    async submitForm(v) {
      ...
      this.loading.p = true;
      await subadminPost(`/company-add-blogs`, v).then((response) => {
