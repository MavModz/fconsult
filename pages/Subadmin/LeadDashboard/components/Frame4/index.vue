    ...
    <div class="frame">
        <div class="medium-transfers">
            ...
            <div v-if="FollowupData?.length > 0" class="custom-followups-adjustment">
                ...
                <button class="CTA">
                    <NuxtLink class="text-wrapper" to="/subadmin/leads/followup">View all <span><i
            ...
            <div v-else>
                ...
                <div style="text-align: center;">
                    ...
                    <p class="text-[#ff5757] cst-viewleads-follow" @click="$router.push('/subadmin/leads/view')"> <span><i
                ...
                <div class="custom-table-parent-scroll">
                    ...
                    <div v-else class="parent-checknull-table">
                        ...
                        <span style="border: 1px solid #ff5757; border-radius: 6px; font-weight: 500; cursor: pointer;"
                            ...
                            @click="$router.push('/subadmin/settings/UserRoleManagement')"><i class="bi bi-plus"
...
export default {
    ...
    methods: {
        async FollowUps() {
            try {
                const res = await subadminPost('/view-followup')
        ...
        async UserLeads() {
            try {
                const res = await subadminGet('/admin-dashboard-user-based-leads')
        ...
        async fAndCrm() {
            try {
                const res = await subadminGet('/admin-dashboard-crm-lead-managment')
        ...
        async topSeller() {
            try {
                const res = await subadminGet('/admin-get-top-services')
        ...
        async fetchRevenue() {
            try {
                ...
                const res = await subadminPost('/admin-dashboard-user-based-leads', { start: startDate, end: endDate });
                this.tableData = res.data.data;
            } catch (e) {
                console.error(e);
            }
        ...
        async fetchRevenue2() {
            try {
                ...
                const res = await subadminPost('/view-followup-date', { start: startDate, end: endDate })
                this.FollowupData = res.data.data;
            } catch (e) {
                console.error(e);
            }
        ...
        async fetchRevenue3() {
            try {
                ...
                const res = await subadminPost('/admin-get-top-services', { start: startDate, end: endDate })
                this.services = res.data.data;
            } catch (e) {
                console.error(e);
            }
