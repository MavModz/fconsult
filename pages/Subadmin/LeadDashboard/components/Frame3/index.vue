                ...
                <div class="div-11">
                    ...
                    <div v-else class="d-flex flex-col items-center gap-y-[12px]">
                        ...
                        <p style="border: 1px solid #ff5757; width: fit-content; border-radius: 8px; cursor: pointer;"
                            ...
                            @click="$router.push('/subadmin/leadintegration')"><img class="pt-[4px]"
    ...
    methods: {
        ...
        async fetchRevenue() {
            try {
                ...
                const res = await subadminPost('/admin-dashboard-facebook-lead-history', { start: startDate, end: endDate });
        ...
        async fetchRevenue2() {
            try {
                ...
                const res = await subadminPost('/admin-dashboard-integration-level', { start: startDate, end: endDate });
        ...
        async LeadFunnel() {
            try {
                const res = await subadminGet('/admin-dashboard-lead-funnel');
        ...
        async InstitLevel() {
            try {
                const res = await subadminGet('/admin-dashboard-integration-level');
                this.InstitData = res.data.data;
            } catch (e) {
                console.error(e);
            }
        ...
        async metaFacebook() {
            try {
                const res = await subadminGet('/admin-dashboard-facebook-lead-history');
                this.fbData = res.data.data;
            } catch (e) {
                console.error(e);
            }
