    ...
    <div class="agreement-wrapper">
      <div class="agreement-header-container">
        ...
        <div class="pipeline-section3-row1" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop"
          ...
          <div class="pipeline-section3-border" v-if="permission?.agreement?.add">
              ...
              <div class="flex flex-wrap gap-3">
                <div v-for="(item, index) in s.items" :key="index" class="agreement-content-1stbox">
                    ...
                    <div class="agreement-content-threedots">
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="pipeline-drop">
                          ...
                          <li @click="editagreement(item._id)" class="drop-two" v-if="permission?.agreement?.edit">
                  ...
                  <div class="agreement-row2-col4">
                    ...
                    <div class="pipeline-card-delete cursor-pointer" v-if="permission?.agreement?.delete">
...
serviceError: false,
  ...
  this.$router.push({
    path: '/subadmin/Agreement/GenerateAgrem',
    query: {
      ...
      editagreement(id) {
        this.$router.push({
          path: '/subadmin/Agreement/UpdateAgrem',
          query: { data: id },
        });
      },
      async getagreement() {
        await subadminGet(`/view-agreement`).then((response) => {
      ...
      async deleteagreement(id) {
        this.loading = true;
        await subadminDelete(`/delete-agreement/${id}`).then((res) => {
          if (res.data.status) {
