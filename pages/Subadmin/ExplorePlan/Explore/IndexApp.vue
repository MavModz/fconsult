      ...
      <div class="explore-section1">
        <div class="explore-section1-wrapper">
          <div class="explore-row1">
            <NuxtLink to="/subadmin/dashboard"><img src="/img/png/logo F&C.png" alt="logo" /></NuxtLink>
          </div>
        ...
        <div class="explore-section2-row1">
          ...
          <div class="explore-section2-row6" v-if="plan || prom || memb">
            ...
            <div class="exp-app-builter-btn">
              <NuxtLink to="/subadmin/ExplorePlan/Builder">
...
export default {
  ...
  methods: {
    ...
    async generateLinkFull(type, amt) {
      ...
      let data = {
        notes: {
          ...
          type: type,
          returnUrl: '/subadmin/dashboard',
        },
        amount: amt,
        callbackUrl: `${window.location.origin}/subadmin/verifyplanpayment`,
    ...
    toggleValue() {
      ...
      this.prom = false;
      this.memb = false;
      this.$router.push('/subadmin/ExplorePlan/Builder');
    },
    toggleprom() {
      this.prom = !this.prom;
      this.memb = false;
      this.plan = false;
      this.$router.push('/subadmin/ExplorePlan/Memberplan');
    },
    togglememb() {
      this.memb = !this.memb;
      this.prom = false;
      this.plan = false;
      this.$router.push('/subadmin/ExplorePlan/AddMember');
    },
  },
  computed: {
    dynamicId() {
