          ...
          <div class="btheme-row5">
            ...
            <div class="btheme-row5-col2">
              ...
              <div class="btheme-row5-input2">
                <input type="text" placeholder="cta name" required />
              </div>
            </div>
          </div>
          <div class="btheme-row6">
            <button @click="request">LAUNCH MY APP!<img src="/img/png/hbdd.png" /></button>
          </div>
...
export default {
  ...
  methods: {
    ...
    request() {
      if (this.checkbox) {
        this.$router.push('/subadmin/ExplorePlan/Builderequest');
      }
    },
    addColor() {
