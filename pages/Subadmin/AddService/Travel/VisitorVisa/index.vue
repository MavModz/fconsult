    ...
    <div class="form-section">
        ...
        <!-- <div class="input-group">
            ...
            <label class="upload-box cursor-pointer">
                ...
                <img v-if="listService.logo_file_name" :src="listService.countryLogo" alt="Logo Preview"
                    class="logo-thumb" />
            ...
            <p v-if="validationErrors.countryLogo" class="!text-red-500 text-sm mt-1">
                {{ validationErrors.countryLogo }}
            </p>
        </div> -->
        <div class="grid">
  ...
  if (hasIncompleteTab) {
    ...
    return;
        ...
        async fetchAdminCountries(category_name) {
            ...
            try {
                const response = await subadminGet(`/admin-company-country-flag-providing-service/${category_name}`);
