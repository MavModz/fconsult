  ...
  >
    <div class="email-triggers">
      ...
      <div v-if="settings.customer_welcome_email" class="languages">
        ...
        <div class="edit-email">
          <button
            @click="
              $router.push('/subadmin/emailtemplates/add/customer_welcome_email')
            "
          >
            Edit Email Template
          </button>
      ...
      <div v-if="settings.serviceRecomendationEmail" class="languages">
        ...
        <div class="edit-email">
          <button
            @click="
              $router.push(
                '/subadmin/emailtemplates/add/serviceRecomendationEmail',
              )
            "
          >
            Edit Email Template
    ...
    <div class="email-triggers">
      ...
      <div v-if="settings.serviceFinalizedEmail" class="languages">
        ...
        <div class="edit-email">
          <button
            @click="
              $router.push('/subadmin/emailtemplates/add/serviceFinalizedEmail')
            "
          >
            Edit Email Template
          </button>
      ...
      <div v-if="settings.customerAppoinmentScheduleEmail" class="languages">
        ...
        <div class="edit-email">
          <button
            @click="
              $router.push(
                '/subadmin/emailtemplates/add/customerAppoinmentScheduleEmail',
              )
            "
          >
            Edit Email Template
    ...
    <div class="email-triggers">
      ...
      <div v-if="settings.DocumentRequestSetting" class="languages">
        ...
        <div class="edit-email justify-content-between align-items-center">
          ...
          <button
            @click="
              $router.push('/subadmin/emailtemplates/add/DocumentRequestSetting')
            "
          >
            Edit Email Template
          </button>
    ...
    <div class="email-triggers">
      ...
      <div v-if="settings.processCompletion" class="languages">
        ...
        <div class="edit-email">
          <button
            @click="$router.push('/subadmin/emailtemplates/add/processCompletion')"
          >
            Edit Email Template
          </button>
        </div>
    ...
    <div class="email-triggers">
      ...
      <div v-if="settings.eventEmailSetting" class="languages">
        ...
        <div class="edit-email justify-content-between align-items-center">
          ...
          <!-- <div class="edit-email"> -->
          <button
            @click="$router.push('/subadmin/emailtemplates/add/eventEmailSetting')"
          >
            Edit Email Template
          </button>
          <!-- </div> -->
...
export default {
  ...
  methods: {
    async updateForm(d) {
      ...
      await subadminPut(`/setting-update`, d).then((response) => {});
