  ...
  <div class="languages" v-if="settings.clientNotification_Alerts && settings.email_triggers && !settings.loading">
    <div class="email-triggers">
      ...
      <div class="edit-email">
        <button @click="$router.push('/subadmin/emailtemplates/add/introduction_email')">
          Edit Email Template
        </button>
      </div>
    </div>
    <div class="email-triggers">
      ...
      <div v-if="settings.appointment_email" class="edit-email">
        <button @click="$router.push('/subadmin/emailtemplates/add/appointment_email')">
          Edit Email Template
        </button>
      </div>
    </div>
    <div class="email-triggers">
      ...
      <div v-if="settings.lead_to_customer_email" class="edit-email">
        <button @click="
          $router.push('/subadmin/emailtemplates/add/lead_to_customer_email')
          ">
          Edit Email Template
        </button>
      </div>
    ...
    <div class="email-triggers">
      ...
      <div v-if="settings.event_email" class="edit-email">
        <button @click="$router.push('/subadmin/emailtemplates/add/event_email')">
          Edit Email Template
        </button>
      </div>
    </div>
