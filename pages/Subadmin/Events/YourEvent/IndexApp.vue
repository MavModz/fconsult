              ...
              <div class="your-events-1stbox-content-threedots">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <NuxtLink :to="'/subadmin/events/View-Webinar/' + item._id"><a class="dropdown-item">
                        <i class="bi bi-eye"></i> View</a></NuxtLink>
                    <NuxtLink :to="'/subadmin/events/updateEvents/' + item._id"><a class="dropdown-item"><i
          ...
          <div class="your-events-1stbox-contentdetails">
            <div class="your-events-1stbox-content-start">
              ...
              <div class="your-events-1stbox-content-threedots">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <NuxtLink :to="'/subadmin/events/View-Seminar/' + item._id"><a class="dropdown-item"><i
            ...
            <div class="your-events-responses">
              <div class="your-event-resinside">
                ...
                <div class="your-event-resinside-text">
                  <NuxtLink :to="'/subadmin/eventsResponse/' + item._id">
                    <span>
                      <p>{{ item.response.length }} Response</p>
                    </span>
                  </NuxtLink>
...
export default {
  ...
  methods: {
    ...
    async deleteEvent() {
      ...
      try {
        $('#close').click();
        const res = await subadminDelete(
    ...
    async init() {
      await subadminGet('/company-events').then((response) => {
