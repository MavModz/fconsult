...
<template>
  ...
  <Dialog v-model:visible="addModal" modal header="Add Language Details">
    <FormKit type="form" @submit="addLanguages" >
      <div>
        ...
        <FormKit validation="required" v-model="selectedLanguage" id="update-events-drpsem-add" class="form-select" placeholder="Select Language"
          name="examination_name" type="select" @change="initField" :options="languages" />
      </div>
      <div class="mb-3">
      ...
      <div class="modal-footer-section">
        <button @click="addModal = false" type="button" class="btn-btn-cancel" data-bs-dismiss="modal" id="close">Go back</button>
