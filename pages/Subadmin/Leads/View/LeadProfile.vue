         ...
         <div class="single-lead-profile">
            <div class="single-lead-backg-clr-viewpf">
               <div class="single-lead-abs-image-view">
                  <img :src="data.image+ `?t=${new Date().getDay()}`" alt="">
               </div>
            </div>
            <div class="single-lead-inside-name-view">
               <span class="single-lead-actmae">
                  <p>{{getSlicedContent(data.name,40)}}</p> 
               </span>
               <!-- <span>
              ...
              <div class="single-overview-email">
                <div class="single-eml-wdth">
                    ...
                    <div class="single-ovr-spn">
                      ...
                      <input class="single-lead-nptphn" :value="data.phone" type="text" placeholder="enter your phone number" readonly>
                    </div>
                </div>
                <div class="single-eml-wdth">
                    ...
                    <div class="single-ovr-spn">
                      ...
                      <input class="single-lead-nptphn" :value="data.email" type="email" placeholder="enter your email" readonly>
                    </div>
                </div>
              </div>
