  ...
  <Dialog v-model:visible="addPrimaryModal" modal header="Add Primary Education Details" :draggable=false>
    <FormKit type="form" @submit="addPrimary">
      ...
      <div class="mb-3">
        ...
        <FormKit validation="required" type="date" id="update-events-drpsem-add" name="passing_year" validation-label="Passing Year"/>
...
export default {
  ...
  methods: {
    ...
    addPrimary(v) {
      ...
      console.log("this.lead.primary",this.lead.primary)
    },
    deletePrimary(i) {
