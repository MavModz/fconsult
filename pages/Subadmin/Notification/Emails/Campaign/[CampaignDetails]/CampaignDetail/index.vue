<template>
  ...
  <div v-if="isShow">
    ...
    <div class="w-[100%]  bg-[#ffffff] border-[2px] border-[#ededed] p-[19px] sm:p-[26px] md:p-[35px] rounded-[18px]">
      <div class="first-head-section gap-2 flex flex-wrap pb-[16px] justify-content-between">
        ...
        <div class="flex items-center flex-wrap  gap-2 sm:gap-3">
          ...
          <router-link to="/subadmin/notification/emails/campaign/campaignresponses"
    ...
    <div
      ...
      <div class="flex flex-wrap gap-2 items-center justify-between">
        ...
        <router-link :to="`/subadmin/notification/emails/campaign/${this.$route.params.CampaignDetails}/campaignresponses`"
  ...
  <template #body="slotProps">
    ...
    <CampaignFilter v-model="showFilterSidebar" @apply-filters="handleFilter" campaignDetails=true   ref="filterComponent"/>
...
const routes = [
  {
    path: '/subadmin/notification/emails/campaign/campaignresponses',
