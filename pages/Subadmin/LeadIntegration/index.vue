  ...
  <div class="row mx-0">
    <div class="col-md-12">
      <div class="crm-details">
        ...
        <div>
          <NuxtLink to="/subadmin/LeadIntegration/ConnectIntegrations" class="integration-btn">Connected Integrations</NuxtLink>
        </div>
      </div>
      <br />
      <div class="row">
      ...
      crmIntegrationModules: [
        {
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/leadIntegration/meta"
        },
        {
          id: 2,
          name: 'Google Sheet',
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/leadIntegration/googlesheet"
        },
        {
          id: 3,
          name: 'Google AD’s',
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/leadIntegration/googleadd"
        },
        {
          id: 4,
          name: 'Custom Form',
        ...
        },
        {
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: '/subadmin/leadIntegration/LeadAutomation',
        },
        {
          id: 6,
          ...
          isUpcoming: false,
          crmIncuded: true,
          route: "/subadmin/leadIntegration/WordPress"
        },
      ]
    };
  },
