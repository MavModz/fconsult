                ...
                <div class="col-sm-12">
                    <FormKit type="form" @submit="addOnsite">
                        ...
                        <div class="mt-4">
                            ...
                            <FormKit type="text" validation="required|noLeadingSpace" name="summary" :validation-rules="{ noLeadingSpace }"
  :validation-messages="{ 
...
/>
  ...
  :validation-rules="{ minChars }" :validation-messages="{
    required: 'Description is required.',
    minChars: 'Description must be at least 60 characters long.'
  }"  validation-visibility="live" />
